...
const COLOR_STRING_WORLD = new core_1.b2Color(0.5, 0.9, 0.5);
...
class DebugDraw {
    ...
    DrawTransform(xf) {
        ...
        this.ctx.moveTo(0, 0);
        this.ctx.lineTo(1, 0);
        this.ctx.strokeStyle = DebugDraw.MakeStyleString(core_1.b2Color.RED);
        this.ctx.stroke();
        this.ctx.beginPath();
        this.ctx.moveTo(0, 0);
        this.ctx.lineTo(0, 1);
        this.ctx.strokeStyle = DebugDraw.MakeStyleString(core_1.b2Color.GREEN);
        this.ctx.stroke();
    ...
    DrawString(x, y, align, message) {
        ...
        this.ctx.fillStyle = DebugDraw.MakeStyleString(core_1.b2Color.WHITE);
        // ctx.shadowOffsetX = 3;
        // ctx.shadowOffsetY = 3;
        // ctx.shadowBlur = 2;
