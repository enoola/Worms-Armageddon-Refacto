...
export class WeaponsMenu {
    ...
    private cssId: string = 'weaponsMenu';
    private toggleButtonCssId: string = 'weaponsMenuBtn';
    ...
    constructor(gameInstance: Game) {
        ...
        document.body.addEventListener('mousedown', (event) => {
            if (
                ...
                (event.target as HTMLElement).matches(`[data-toggle-weapon-menu]`)
            ) {
                this.toggle();
            }
        });
    ...
    selectWeapon(weaponId: number): void {
        ...
        if (weaponMgmt.checkWeaponHasAmmo(weaponId)) {
            ...
            Client.sendImmediately(
                ...
                new InstructionChain("state.getCurrentPlayer.getTeam.getWeaponManager.setCurrentWeapon", [weaponId])
            );
        }
    }
    ...
    populateMenu(listOfWeapons: BaseWeapon[]): void {
