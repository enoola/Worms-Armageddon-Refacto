...
class ProjectileWeapon extends BaseWeapon {
    constructor(name, ammo, iconSpriteDef, weaponSpriteDef, takeOutAnimation, takeAimAnimation) {
        super(name, ammo, iconSpriteDef, takeOutAnimation, takeAimAnimation);
...
class Bazzoka extends ProjectileWeapon {
    constructor(ammo) {
        super("Bazooka", ammo, Sprites.weaponIcons.bazooka, Sprites.weapons.missle, Sprites.worms.takeOutBazooka, Sprites.worms.aimBazooka);
    }
}
