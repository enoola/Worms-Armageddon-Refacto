...
(function (keyboard) {
     ...
     */
    function isKeyDown(keyCode, actLikeKeyPress = false) {
    ...
    */
     ...
     * @param keyCodes
     */
    const keyCodeToKey = Object.keys(keyboard.keyCodes).reduce((acc, key) => {
        const typedKey = key;
        acc[keyboard.keyCodes[typedKey]] = typedKey;
        return acc;
    }, {});
    /**
